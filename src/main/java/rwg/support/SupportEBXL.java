...
public class SupportEBXL {
    ...
    public static void init() {
        ...
        if (BiomeManager.extremejungle.isPresent()) {
            Support.addBiome(
                    new RealisticBiomeSupport(
                            BiomeManager.extremejungle.get(),
        ...
        if (BiomeManager.forestedisland.isPresent()) {
            Support.addBiome(
                    new RealisticBiomeSupport(
                            BiomeManager.forestedisland.get(),
                            RWGBiomes.baseRiverTemperate,
        ...
        if (BiomeManager.forestedhills.isPresent()) {
            Support.addBiome(
                    new RealisticBiomeSupport(
                            BiomeManager.forestedhills.get(),
                            RWGBiomes.baseRiverTemperate,
                            new TerrainHilly(230f, 120f, 0f),
                            new SurfaceMountainStone(
        ...
        if (BiomeManager.mountaintaiga.isPresent()) {
            Support.addBiome(
                    new RealisticBiomeSupport(
                            BiomeManager.mountaintaiga.get(),
                            RWGBiomes.baseRiverIce,
        ...
        if (BiomeManager.redwoodforest.isPresent()) {
            Support.addBiome(
                    new RealisticBiomeSupport(
                            BiomeManager.redwoodforest.get(),
                            RWGBiomes.baseRiverTemperate,
                            new TerrainHilly(230f, 120f, 0f),
                            new SurfaceMountainStone(
